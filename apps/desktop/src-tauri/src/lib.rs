...
pub fn run() {
    ...
    let app_state = AppState {
        ...
        dictation_last_text: Mutex::new(None),
        main_window_focused: std::sync::atomic::AtomicBool::new(false),
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::dictation_last_text,
            commands::set_main_window_focused,
            ...
            agents::bridge::ssh_config_aliases,
